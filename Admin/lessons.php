...
if (!empty($keywords)) {
    ...
    $sql = "SELECT * FROM lessons WHERE title like :keywords";
...
<body>
    <div class="search-container">
        ...
        <a href="lessons.php?clear_search=1" class="clear_search"><span class="material-symbols-outlined">close</span></a>
    </div>
    ...
    <form method="post" action="" name="ManageMainForm" id="ManageMainForm">
        <table>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="8">Do Not Have Task at Now.</td>
                </tr>
            <?php endif; ?>
            </tbody>
        </table> 
