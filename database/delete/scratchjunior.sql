...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2025 at 01:12 PM
...
('CW000002', 'LL000004', 'CLS000004', 'timetable.pdf', '2025-05-07 18:50:00');
...
('LL000004', 'zsdvg', 'tgg', '2025-05-05 13:06:57', 'time table d4.jpg', '/phpfile/uploads/thumbnail/time table d4.jpg', 'timetable.pdf', '/phpfile/uploads/timetable.pdf', 3);
...
('DDC8899', 'STU2025000002', 'DDC8899', '2025-05-05 09:32:26'),
('SC000001', 'STU2025000003', 'CLS000004', '2025-04-28 08:20:19');
...
INSERT INTO `student_submit_feedback` (`feedback_id`, `student_id`, `submit_id`, `rating`, `comments`, `created_at`) VALUES
(3, '', 'SS000001', 4, '22222', '2025-05-05 06:59:54'),
(4, 'STU2025000003', 'SS000001', 2, 'eeqfdeff', '2025-05-05 10:22:11');
...
--
-- Indexes for table `student_submit_feedback`
--
...
--
-- AUTO_INCREMENT for table `student_submit_feedback`
--
ALTER TABLE `student_submit_feedback`
...
--
-- Constraints for table `student_submit_feedback`
--
ALTER TABLE `student_submit_feedback`
