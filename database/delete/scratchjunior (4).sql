...
(26, 'user', 'ytboy', '2025-04-17 09:50:45', '4.jpg', '/phpfile/uploads/thumbnail/Screenshot_2.png', '1221206295_FYP_Progress -TFP4224.pdf', '/phpfile/uploads/Elicit - E-Learning vs. Traditional Coding Education Outcom - Report.pdf'),
...
--
ALTER TABLE `student_class`
  MODIFY `student_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `lesson_class`
  ADD CONSTRAINT `lesson_class_ibfk_1` FOREIGN KEY (`lesson_id`) REFERENCES `lessons` (`lesson_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `lesson_class_ibfk_2` FOREIGN KEY (`class_id`) REFERENCES `class` (`class_id`) ON DELETE CASCADE;

--
-- 限制表 `lesson_student`
--
ALTER TABLE `lesson_student`
  ADD CONSTRAINT `lesson_student_ibfk_1` FOREIGN KEY (`lesson_id`) REFERENCES `lessons` (`lesson_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `lesson_student_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`) ON DELETE CASCADE;
